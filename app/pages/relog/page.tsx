...
const formSchema = z.object({
  ...
  Qz_Vt: z.number().min(0).max(7), //  Weathering_Type
  Qz_Alt: z.number().min(0).max(7), //Natural_Break_Count
  Sulphides: z.number().min(0).max(7), //Broken_Zone_Count
  Bleaching: z.number().min(0).max(7),
  Carbonates: z.number().min(0).max(7),
  Limonites: z.number().min(0).max(7),
