...
const formSchema = z.object({
  ...
  Qz_Alt: z.number().min(0).max(10), //Natural_Break_Count
  Sulphides: z.number().min(0).max(10), //Broken_Zone_Count
  Bleaching: z.number().min(0).max(10),
  Carbonates: z.number().min(0).max(10),
  Limonites: z.number().min(0).max(10),
  Sulphides_As: z.number().min(0).max(10),
  Sulphides_Py: z.number().min(0).max(10),
  Sulphides_Sp: z.number().min(0).max(10),
  Sulphides_Cpy: z.number().min(0).max(10),
  Sulphides_Po: z.number().min(0).max(10),
  Sulphides_Undiff: z.number().min(0).max(10),
  Bleaching_Cly: z.number().min(0).max(10),
  Bleaching_Ser: z.number().min(0).max(10),
  Bleaching_Alb: z.number().min(0).max(10),
  Silicification: z.number().min(0).max(10),
  Veinlets_Qz_Po: z.number().min(0).max(10),
  Veinlets_Qz_Py: z.number().min(0).max(10),
  Veinlets_Py_As: z.number().min(0).max(10),
  Veinlets_Qz_Su: z.number().min(0).max(10),
  Veinlets_Ca: z.number().min(0).max(10),
  Veinlets_Qz_Ca: z.number().min(0).max(10),
  Veinlets_Sulf: z.number().min(0).max(10),
  Veinlets_Qz_Undiff: z.number().min(0).max(10),
  Veinlets_Bt: z.number().min(0).max(10),
  Comments: z.string(),
});
